...
export class Userservice {
  ...
  resetPassword(Data: any, token: any) {
    ...
    return this.httpService.postService(`https://localhost:44359/api/Users/Reset?password=${Data.password}&confirmPassword=${Data.confirmPassword}`, Data, true, header);
  }
